...
// ============================================================
// matchingExecutables — the PATH-scan behind command-word completion,
// both the single-match case and the double-<TAB> match listing
// ============================================================
...
func TestMatchingExecutables_Valid(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			why:     "spec: exactly one match is what the command-word completion completes to immediately",
		},
		{
